...
struct Node {
	...
	enum OpType : int {
		FM_CONVERSION_OP, CELL_DILATION_OP, REGION_DILATION_BY_CELL_COVERAGE_OP, REGION_DILATION_BY_ITEM_COVERAGE_OP, COMPASS_OP, RELEVANT_ELEMENT_OP,
		IN_OP, NEAR_OP,
		SET_OP, BETWEEN_OP,
...
struct Token {
	enum Type : int {
		...
		FM_CONVERSION_OP,
		CELL_DILATION_OP,
		REGION_DILATION_BY_CELL_COVERAGE_OP,
		REGION_DILATION_BY_ITEM_COVERAGE_OP,
		COMPASS_OP,
		RELEVANT_ELEMENT_OP,
		BETWEEN_OP,
		IN_OP,
